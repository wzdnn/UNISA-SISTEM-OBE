...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-[#20CB90] sm:translate-x-0"
    aria-label="Sidebar">
    <div class="px-6 pt-3">
        <div class="flex items-center justify-between">
            ...
            <button
            class="flex items-center justify-center p-1.5 rounded bg-green-800 focus:outline-none focus:ring-1 focus:ring-green-500"
            >
            <svg
