<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('cpl.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 ">Capaian Lulusan</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="{{ route('cpmk') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75  group-hover:text-gray-900 "
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Pemetaan CPMK</span>
                </a>
            </li>          
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Penilaian Bahan Kajian</span>
                ...
                <ul id="dropdown-list-user" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('bk.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">Bahan Kajian</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="{{ route('home.matakuliah') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75  group-hover:text-gray-900 "
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="m17.418 3.623-.018-.008a6.713 6.713 0 0 0-2.4-.569V2h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2H9.89A6.977 6.977 0 0 1 12 8v5h-2V8A5 5 0 1 0 0 8v6a1 1 0 0 0 1 1h8v4a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-4h6a1 1 0 0 0 1-1V8a5 5 0 0 0-2.582-4.377ZM6 12H4a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2Z" />
