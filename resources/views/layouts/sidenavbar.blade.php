        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-list-user" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('list.subbk') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">Peta SubBK-CPMK</a>
                    </li>
                </ul>
            </li>
            <li>
