<nav
    class="flex flex-col w-screen md:relative md:top-0 md:w-full bg-white shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex items-center ml-3">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        <div class="px-4 py-3" role="none">
                            ...
                            <p class="text-sm font-medium text-gray-900  dark:hover:text-gray-500 truncate dark:text-gray-300"
                                role="none">
                                {{ Auth::user()->email }}
                            </p>
                            <p class="text-sm font-medium text-gray-900  dark:hover:text-gray-500 truncate dark:text-gray-300"
