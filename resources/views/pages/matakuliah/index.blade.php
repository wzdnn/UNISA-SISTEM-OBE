...
<div class="relative py-3">
    <table class="w-full text-sm text-center  text-gray-500">
        ...
        <tbody>
            ...
            @foreach ( $matakuliah as $mk => $value )
            <tr class="bg-white border-b text-left">
                ...
                <td class=" px-6 py-4">
                    <a href="{{ route('detail.mk', ['id' => $value->kdmatakuliah]) }}">
                        <button type="button"
                            class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 "><i class="fa-solid fa-circle-info"></i></button>
                    </a>
                </td>
