...
@section('body')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Kelola CPMK</span>
                </div>
            </li>
    ...
    <h1 class="font-bold text-2xl mb-4 text-blue-800 uppercase">Kelola CPMK</h1>
