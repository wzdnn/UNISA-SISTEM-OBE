    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        <li class="inline-flex items-center">
            <a href="{{ route('cplr.create') }}"
                ...
                Referensi Capaian Pembelajaran Lulusan
            </a>
        </li>
</nav>
...
<div class="flex items-center justify-between py-5 px-5">
    <div class="flex items-center">
        <h1 class="font-bold text-2xl mb-0 text-gray-700 text-center"> Referensi Capaian Pembelajaran Lulusan
</h1>
    </div>
    <div class="flex items-center">
...
{{-- @section('body') --}}
    ...
    <div class="relative py-3">
        ...
        {{ $akKurikulumCplr->withQueryString()->links() ?? '' }}
        <hr />
    </div>
    <script>
        //on load
