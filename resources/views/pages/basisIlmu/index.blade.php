...
@section('body')
    ...
    <div class="flex items-center justify-between py-5 px-5">
        <div class="flex items-center">
            <h1 class="font-bold text-2xl mb-0 text-gray-700 text-center">Basis Ilmu</h1>
        </div>
        <div class="flex items-center">
...
@section('body') --}}
        ...
        <h1 class="font-bold text-2xl mb-0 text-gray-700">Basis Ilmu</h1>
        @if (Auth::user()->role == 'admin')
            <button data-modal-target="defaultModal" data-modal-toggle="defaultModal"
                class="block text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button">
                        ...
                        <div class="">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <label for="basis_ilmu"
                                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Basis
                                    Ilmu</label>
                            </div>
                        </div>
                        ...
                        <tr class="{{ $key % 2 == 0 ? 'bg-gray-100' : 'bg-gray-50' }} border-b text-left">
                            ...
                            @if (Auth::user()->role == 'admin')
                                <td class="px-6 py-4">
                                    ...
                                    <a href="{{ route('delete.basil', ['id' => $basils->id]) }}"
