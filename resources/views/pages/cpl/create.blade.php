...
@section('body')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Tambah Capaian
                        Pembelajaran Lulusan</span>
                </div>
            </li>
    ...
    <div class="text-center">
        <h1 class="font-bold text-2xl mb-0 text-gray-700">Tambah Capaian Pembelajaran Lulusan</h1>
    </div>
    {{-- <hr /> --}}
    @if ($errors->any())
        ...
        <div class="px-3 bg-white border border-gray-200 rounded shadow-lg justify-between">
            <form class="py-3" action="{{ route('cpl.store') }}" method="POST">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class=" hidden relative z-0 w-full mb-6 group">
                        <input type="text" name="cpl" id="cpl"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none   focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ old('cpl') }}" />
                        <label for="cpl"
                    ...
                    <div class="flex flex-col z-0 w-full mb-6 group">
                        ...
                        <select id="cplr" name="kdcplr[]" multiple data-live-search="true" class="form-control">
