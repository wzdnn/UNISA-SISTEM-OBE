...
@section('body')
    <div class="flex items-center justify-between py-5 px-5 mx-10">
        <h1 class="font-bold text-2xl mb-0">Tambah Bahan Kajian</h1>
    </div>
    <hr />
    @if ($errors->any())
    ...
    <form class="py-3" action="{{ route('bk.store') }}" method="POST">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <select id="inputState" name="basil" class="form-control">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <select id="inputState" name="bidil" class="form-control">
