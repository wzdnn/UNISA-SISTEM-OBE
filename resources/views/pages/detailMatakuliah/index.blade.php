...
@section('body')
    ...
    <div class="text-center">
        <h1 class="font-bold text-2xl mb-0 text-dark-700">Tambah Referensi Materi Pada Matakuliah
    ...
    <div class="my-3 mx-auto max-w-4xl">
        <div class=" px-3 bg-white border border-gray-200 rounded-lg shadow-lg justify-between">
            <div class="px-3 ">
                <form action="{{ route('referensi.store', ['id' => $matakuliah->kdmatakuliah]) }}" method="POST">
                    @csrf
                    <div class="px-3 py-3">
                        <h3 class="font-medium text-lg mb-3">Utama</h3>

                        <label for="referensi_utama"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Referensi Utama</label>
                        <button type="button"
                    ...
                    <div class="px-3 py-3">
                        ...
                        <label for="referensi_tambahan"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Referensi Tambahan</label>
                        <button type="button"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1 mb-3 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                            id="btnTambahReferensiTambahan"><i class="fa fa-plus" aria-hidden="true"></i></button>
