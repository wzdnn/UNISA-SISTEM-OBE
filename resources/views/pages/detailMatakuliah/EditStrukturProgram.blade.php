...
@section('body')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Edit Struktur
                        Program</span>
                </div>
            </li>
        </ol>
    ...
    <div class="text-center py-2">
        <h1 class="font-bold text-2xl mb-0">Edit Struktur Program</h1>
    </div>

    <div class="my-3 mx-auto max-w-4xl">
        <div class="px-3 bg-white border border-gray-200 rounded shadow-lg justify-between">
            <form class="py-3" action="{{ route('sp.update', ['id' => $strukturProgram->kdstrukturprogram]) }}"
                method="POST">
                @csrf
                    ...
                    <div class="flex flex-col z-0 w-full mb-6 group">
                        ...
                        <select id="kdmatakuliah" name="kdmatakuliah" class="form-control">
                            @foreach ($matakuliah as $mk)
                                <option value="{{ $mk->kdmatakuliah }}"@selected(in_array($mk->kdmatakuliah, $id_Mk))>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="flex flex-col z-0 w-full mb-6 group">
                        ...
                        <select id="dosen1" name="dosen1[]" multiple="multiple" data-live-search="true"
                            class="form-control">
                            @foreach ($dosen1 as $dos1)
                                <option value="{{ $dos1->kdperson }}" @selected(in_array($dos1->kdperson, $id_DUtama))>{{ $dos1->gelardepan }}
                                    {{ $dos1->namalengkap }}
                                    {{ $dos1->gelarbelakang }}
                                </option>
                            @endforeach
                    ...
                    <div class="flex flex-col z-0 w-full mb-6 group">
                        ...
                        <select id="dosen2" name="dosen2[]" multiple data-live-search="true" class="form-control">
                            @foreach ($dosen2 as $dos2)
                                <option value="{{ $dos2->kdperson }}" @selected(in_array($dos2->kdperson, $id_DPelaporan))>
                                    {{ $dos2->gelardepan }}
                                    {{ $dos2->namalengkap }}
                                    {{ $dos2->gelarbelakang }}
                                </option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="keterangan" id="keterangan" required
                            ...
                            placeholder=" " value="{{ $strukturProgram->keterangan }}" />
                ...
                <div class="grid md:grid-cols-2 md:gap-6 mt-3">
                    <div class="relative z-0   mb-6 group">
                        ...
                        <select id="teori" name="teori"
                            ...
                            <option selected value={{ $strukturProgram->teori }}>{{ $strukturProgram->teori }}</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_kt" name="pertemuan_kt"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_kt }}>
                                {{ $strukturProgram->pertemuan_kt }}</option>
                            <option value=0>0</option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="tutorial" name="tutorial"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->tutorial }}>{{ $strukturProgram->tutorial }}
                            </option>
                            <option value=0>0</option>
                            <option value=0.5>0.5</option>
                            <option value=1>1</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_kp" name="pertemuan_kp"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_kp }}>
                                {{ $strukturProgram->pertemuan_kp }}</option>
                            <option value=0>0</option>
                            <option value=4>4</option>
                            <option value=8>8</option>
                            <option value=12>12</option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="seminar" name="seminar"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->seminar }}>{{ $strukturProgram->seminar }}
                            </option>
                            <option value=0>0</option>
                            <option value=0.5>0.5</option>
                            <option value=1>1</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_s" name="pertemuan_s"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_s }}>{{ $strukturProgram->pertemuan_s }}
                            </option>
                            <option value=0>0</option>
                            <option value=4>4</option>
                            <option value=8>8</option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="praktikum" name="praktikum"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->praktikum }}>{{ $strukturProgram->praktikum }}
                            </option>
                            <option value=0>0</option>
                            <option value=0.5>0.5</option>
                            <option value=1>1</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_p" name="pertemuan_p"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_p }}>{{ $strukturProgram->pertemuan_p }}
                            </option>
                            <option value=0>0</option>
                            <option value=4>4</option>
                            <option value=8>8</option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="praktik" name="praktik"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->praktik }}>{{ $strukturProgram->praktik }}
                            </option>
                            <option value=0>0</option>
                            <option value=0.5>0.5</option>
                            <option value=1>1</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_pr" name="pertemuan_pr"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_pr }}>
                                {{ $strukturProgram->pertemuan_pr }}</option>
                            <option value=0>0</option>
                            <option value=4>4</option>
                            <option value=8>8</option>
                            <option value=12>12</option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="belajar_mandiri" name="belajar_mandiri"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->belajar_mandiri }}>
                                {{ $strukturProgram->belajar_mandiri }}</option>
                            <option value=0>0</option>
                            <option value=0.5>0.5</option>
                            <option value=1>1</option>
                            <option value=1.5>1.5</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_bm" name="pertemuan_bm"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_bm }}>
                                {{ $strukturProgram->pertemuan_bm }}</option>
                            <option value=0>0</option>
                            <option value=4>4</option>
                            <option value=8>8</option>
                            <option value=12>12</option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="skill_lab" name="skill_lab"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->skill_lab }}>{{ $strukturProgram->skill_lab }}
                            </option>
                            <option value=0>0</option>
                            <option value=0.5>0.5</option>
                            <option value=1>1</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_sl" name="pertemuan_sl"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_sl }}>
                                {{ $strukturProgram->pertemuan_sl }}</option>
                            <option value=0>0</option>
                            <option value=4>4</option>
                            <option value=8>8</option>
                            <option value=12>12</option>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="studio" name="studio"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->studio }}>{{ $strukturProgram->studio }}</option>
                            <option value=0>0</option>
                            <option value=0.5>0.5</option>
                            <option value=1>1</option>
                            <option value=1.5>1.5</option>
                    ...
                    <div class="relative z-0  mb-6 group">
                        ...
                        <select id="pertemuan_studio" name="pertemuan_studio"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value={{ $strukturProgram->pertemuan_studio }}>
                                {{ $strukturProgram->pertemuan_studio }}</option>
                            <option value=0>0</option>
                            <option value=4>4</option>
                            <option value=8>8</option>
                            <option value=12>12</option>
                    ...
                    <div class="flex flex-col z-0 w-full mb-6 group">
                        ...
                        <select id="kurikulum" name="kurikulum" class="form-control ">
                            @foreach ($kurikulum as $k)
                                <option value="{{ $k->kdkurikulum }}" @selected(in_array($k->kdkurikulum, $id_kurikulum))> {{ $k->kurikulum }}
                                    {{ $k->tahun }}
                                </option>
                            @endforeach
                        </select>
