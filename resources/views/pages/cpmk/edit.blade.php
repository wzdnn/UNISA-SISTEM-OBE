...
@section('body')
    ...
    <form action="{{ route('edit.cpmk.post', ['id' => $cpmkEdit->id]) }}" method="POST">
        ...
        <div class="grid gap-4 mb-4 sm:grid-cols-2">
            <div>
                <label for="kode_cpmk" class="block mb-2 text-sm font-medium text-gray-900">Kode
                    CPMK</label>
            ...
            <div>
                <label for="cpmk" class="block mb-2 text-sm font-medium text-gray-900">CPMK</label>
        ...
        {{-- <div class="grid gap-4 mb-4 sm:grid-cols-2">
            <div class="relative z-0 w-full mb-6 group">
                <select id="inputState" name="kdcpl" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-600 focus:border-yellow-600 block w-full p-2.5">
