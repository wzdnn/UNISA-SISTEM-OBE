...
Route::middleware(['auth'])->group(function () {
    ...
    // Dashboard dan Visi Misi Controller
    ...
    // Pengalaman Mahasiswa Controller
    ...
    Route::post('/list-penilaian/mbkm/{id}', [metodePenilaianController::class, 'copyMhsMBKM'])->name('copy.mhs.mbkm');
    ...
    Route::get('/penilaian/mbkm/{id}/{kdtahunakademik}', [metodePenilaianController::class, 'penilaianMBKM'])->name('index.penilaian.mbkm');
    ...
    // Cetak Penilaian MBKM
    Route::get('/cetakPenilaian/mbkm/{id}/{kdtahunakademik}', [metodePenilaianController::class, 'exportNilaiMbkm'])->name('export.nilai.mbkm');
